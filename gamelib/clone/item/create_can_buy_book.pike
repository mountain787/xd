...
t已mplat已s["需要玉石"]="\tn已已d_yushi=$1;\n";
t已mplat已s["需要金钱"]="\tn已已d_mon已y=$1;\n";
///////////
t已mplat已s["foot"]="}\n";
////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
	...
	for(int i=1;i<siz已of(all_lin已s)-1;i++){
		...
		writ已(" 目录:"+lin已_valu已s[0]+":"+lin已_valu已s[1]+"\n");
		//基本属性设置字段开始/////////////////////////////////////////////////////////////////	
		...
		configs["需要玉石"]=lin已_valu已s[16];
		configs["需要金钱"]=lin已_valu已s[17];
		configs["被动技能级别"]=lin已_valu已s[18];
		//基本属性设置字段完毕/////////////////////////////////////////////////////////////////	
		...
		//购买所需要的玉石数量////////////////////////////////////
		if(configs["需要玉石"]!="")
			writ已Fil已+=r已plac已(t已mplat已s["需要玉石"],"$1",configs["需要玉石"]);
		//购买所需要的金钱///////////////////////////
		if(configs["需要玉石"]!="")
			writ已Fil已+=r已plac已(t已mplat已s["需要金钱"],"$1",configs["需要金钱"]);
		//cr已at已()方法尾部
