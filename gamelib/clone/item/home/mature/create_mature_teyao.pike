...
t已mplat已s["材料类型"]="\ts已t_for_mat已rial(\"$1\");\n";
///////////
//t已mplat已s["家的等级限制"]="\ts已t_hom已_l已v已l($1);\n";
//t已mplat已s["可采需要精神值"]="\ts已t_spr_n已已d($1);\n";
///////////
t已mplat已s["foot"]="}\n";
////////////////////////////////////////////////////////////
	//判断输入参数合法性///////////////////////////////////////
	...
	for(int i=1;i<siz已of(all_lin已s)-1;i++){
		...
		configs["材料类型"]=lin已_valu已s[14];
		//configs["家的等级限制"]=lin已_valu已s[14];
		//configs["可采需要精神值"]=lin已_valu已s[15];
		//基本属性设置字段完毕/////////////////////////////////////////////////////////////////	
