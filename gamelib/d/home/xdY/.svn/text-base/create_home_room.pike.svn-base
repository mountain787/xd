...
//针对"家园"系统中的房间，修改了本方法 evan 2008.08.27
//1、家园系统中的房间，不再记录在usr/local/games/usrdata9/room_level文件中；
//2、增加了家园系统中房间的一些特殊方法；
#define ROOT "./"
#define GAMEID "xd9"
...
templates["出口"]="\texits[\"$1\"]=ROOT \"/gamelib/d/home/"+GAMEID+"/$2\";\n";
...
templates["添加指令"]="\nadd_action($1,\"$1\");\n";
	...
	for(int i=1;i<sizeof(all_lines);i++){
		...
		*/
		...
		writeFile += "\tstring tmp=\"\";\n";
		writeFile += "\tstring name = this_object()->query_name();\n";
		writeFile += "\ttmp+= HOMED->banner_slot(name);\n";
		writeFile += "\ttmp+= HOMED->display_flats(name);\n";
		writeFile += "\ttmp+= \"\\n\\n\\n\\n\";\n";
		writeFile += "\treturn tmp;\n";
		writeFile += "}\n";
