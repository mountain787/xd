...
string get_right_href_css(string link_name)
{
	...
	mixed err= catch{
		...
		primary_key_map["【幻化】"]=hrefcss_xuan;
		
		//以下部分是称号对应的颜色
		/*
		mapping(int:string) chenghao_mapping=this_player()->chenghao_mapping;
		if(chenghao_mapping==0){
			mapping(int:string) chenghao_mapping=([
					1:"普通",
					21:"尘世",
					31:"凡人",
					41:"平凡",
		...
		foreach(indices(chenghao_mapping),int l){
			switch(l){
				case 1..100:
					primary_key_map[chenghao_mapping[l]]=hrefcss_green;
					break;
				case 101..1000:
					primary_key_map[chenghao_mapping[l]]=hrefcss_green2;
					break;
				case 1001..2000:
					primary_key_map[chenghao_mapping[l]]=hrefcss_darkorange;
					break;
				case 2001..3000:
					primary_key_map[chenghao_mapping[l]]=hrefcss_orange;
					break;
				case 3001..4000:
					primary_key_map[chenghao_mapping[l]]=hrefcss_purple;
					break;
				case 4001..5000:
					primary_key_map[chenghao_mapping[l]]=hrefcss_tian;
					break;
				case 5001..6000:
					primary_key_map[chenghao_mapping[l]]=hrefcss_huang;
					break;
				case 6001..10000:
					primary_key_map[chenghao_mapping[l]]=hrefcss_xuan;
					break;
			} 
		}
		*/
